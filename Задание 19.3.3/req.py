...
status = 'available'
info = {"id": 0, "category": {"id": 0, "name": "string"}, "name": "doggie", "photoUrls": ["string"], "tags": [{"id": 0, "name": "string"}],
"status": "available"}
new_info = {"id": 0, "category": {"id": 0, "name": "string"}, "name": "doggieRS", "photoUrls": ["string"], "tags": [{"id": 0, "name": "string"}],
"status": "available"}
